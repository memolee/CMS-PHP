...
$subscriber_user_counts = checkUserRole('users','user_role','subscriber');   
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            $elements_text=['Post','Active Post', 'Draft Posts','Comment Count','Pending Comments','user','Subscriber User', 'categories Count'];
            $elements_count=[$post_counts,$post_published_counts, $post_draft_counts, $comment_counts,$unapproved_comment_counts, $user_counts, $subscriber_user_counts, $category_counts];
            
            for($ay=0;$ay<8; $ay++){
                
            echo "['{$elements_text[$ay]}'". "," . "{$elements_count[$ay]}],";
            }
...
<?php include "includes/admin_footer.php" ?>
  ...
  <script>
    ...
    $(document).ready(function(){
        ...
        var pusher = new Pusher('a2861702b37dda69b5be', {
